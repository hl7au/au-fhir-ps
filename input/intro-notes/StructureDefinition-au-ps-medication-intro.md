...
- The Medication resource **SHALL NOT** be used to represent no known medications for a patient. To represent that the patient has no known medications, a MedicationStatement **SHOULD** be used instead. See the [profile specific implementation guidance in AU PS MedicationStatement](StructureDefinition-au-ps-medicationstatement.html#profile-specific-implementation-guidance).