...
* **Patient Story Section**: AU PS supports representation of information about what matters to a patient through the optional Patient Story section. Guidance on the use of the Patient Story section, including appropriate content and implementation approaches, may be a consideration for future versions of AU PS. A candidate example illustrating use of the Patient Story section is provided to support discussion.