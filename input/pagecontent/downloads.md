...
This version of AU PS depends on the current build of IPS and as such it does not produce a registered package with the HL7 FHIR Package Registry. The package can only be downloaded directly from this location.
</div><!-- stu-note -->
