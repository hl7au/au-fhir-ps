...
- changed [AUCDI](aucdi.html) page guidance that the Adverse reaction risk summary - Date/time of onset of first reaction concept is mapped to AllergyIntolerance.onset[x]. [AU PS: FHIR-53631](https://jira.hl7.org/browse/FHIR-53631)
