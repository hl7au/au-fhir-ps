...
- [AU PS Encounter](StructureDefinition/au-ps-encounter):
  - Applied the CodeableConceptIPS data type profile to the following Must Support elements in AU PS Encounter: Encounter.serviceType, Encounter.participant.type and Encounter.reasonCode [FHIR-51872](https://jira.hl7.org/browse/FHIR-51872)
