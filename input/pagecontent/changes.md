...
- [AU PS Composition](StructureDefinition-au-ps-composition.html):
  ...
  - changed Composition.section.entry obligation for the AU PS Producer in all recommended sections from SHOULD:populate-if-known to SHOULD:populate [FHIR-51834](https://jira.hl7.org/browse/FHIR-51834)
