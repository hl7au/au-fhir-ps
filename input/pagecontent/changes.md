...
- [AU PS Medication](StructureDefinition-au-ps-medication.html): 
  - added a root level comment on Medication noting the IPS recommendation to use a reference to a Medication resource, and clarified that AU PS does not adopt this recommendation at this time [FHIR-51876](https://jira.hl7.org/browse/FHIR-51876)
- [AU PS MedicationRequest](StructureDefinition-au-ps-medicationrequest.html):
  ...
  - added a comment on MedicationRequest.medication[x] referencing IPS guidance to prefer a reference to a Medication resource and to use medicationCodeableConcept only when no other information than a simple code is available, and clarified that AU PS does not adopt this guidance at this time [FHIR-51876](https://jira.hl7.org/browse/FHIR-51876)
- [AU PS MedicationStatement](StructureDefinition-au-ps-medicationstatement.html):
  ...
  - added a comment on MedicationStatement.medication[x] referencing IPS guidance to prefer a reference to a Medication resource and to use medicationCodeableConcept only when no other information than a simple code is available, and clarified that AU PS does not adopt this guidance at this time [FHIR-51876](https://jira.hl7.org/browse/FHIR-51876)
