...
<div class="stu-note">
The comparison in this guide is against IPS 2.0.0 following ballot reconciliation. Work on IPS 2.0.0 is ongoing; the CI Build for IPS reflects the latest proposed changes and as such differences to the compared baseline are expected.
</div>
