# Downloads - AU Patient Summary Implementation Guide v1.0.0-ci-build
...
All the profile information for the AU Patient Summary Implementation Guide in a single CSV or Excel file, which may be helpful to testers and analysts to review element properties across profiles in a single table:
